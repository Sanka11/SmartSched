...
import { UserIcon, CalendarIcon, ClockIcon, AcademicCapIcon, BuildingOffice2Icon } from "@heroicons/react/24/outline";
...
const InstructorTimetable = () => {
  ...
  // Days including weekends (only change made - added Saturday and Sunday)
  const days = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"];
  
  // Time slots (keeping original 1-hour periods)
  const timeSlots = [];
  ...
  // Get classes for a specific time slot (fixed the declaration)

    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className={`flex-1 transition-all duration-300 ${sidebarOpen ? 'lg:ml-64' : 'lg:ml-20'}`}>
        ...
        <header className="lg:hidden bg-white shadow-sm p-4 flex items-center justify-between">
          ...
          <h1 className="text-xl font-semibold text-gray-800">Location Management</h1>
              ...
              <div className="p-6 sm:p-8">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                      <label htmlFor="hallName" className="block text-sm font-medium text-gray-700 mb-1">
                        Hall Name *
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="mt-6 flex space-x-3">
                    <button
                      type="submit"
                      disabled={isLoading}
                      className={`px-6 py-3 rounded-lg font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
                    >
                      {isLoading ? (
            ...
            <div className="bg-white shadow-xl rounded-lg overflow-hidden">
              ...
              {isLoading && !locations.length ? (
                ...
                <div className="p-8 text-center">
                  ...
                  <p className="mt-1 text-gray-500">Add your first location using the form above.</p>
                </div>
              ) : (
                      ...
                      <div className="px-6 py-4">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            <div className="ml-4">
                              <h3 className="text-lg font-medium text-gray-900">{loc.hallName}</h3>
                              <p className="text-sm text-gray-500">{loc.buildingName}</p>
